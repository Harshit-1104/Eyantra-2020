...
def init_remote_api_server():
	...
	##############	ADD YOUR CODE HERE	##############
	sim.simxFinish(-1)
	client_id = sim.simxStart('192.168.43.17',19997,True,True,5000,5)
...
def get_vision_sensor_image():
	...
	##############	ADD YOUR CODE HERE	##############
	return_code, vision_handle = sim.simxGetObjectHandle(client_id, 'vision_sensor_1', sim.simx_opmode_blocking)
...
def send_data(maze_array):
	...
	##############	ADD YOUR CODE HERE	##############
	emptybuff = bytearray()
	retrun_code,outInts,outFloat,outString,outBuffer = simx.callScriptFunction(client_id,'base',sim.sim_scripttype_customizationscript,'recieveData',[],[],[],sim.simx_opmode_blocking)
