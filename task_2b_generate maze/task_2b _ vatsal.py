...
def send_data(maze_array):
	...
	return_code, _ , _ , _ , _ = sim.simxCallScriptFunction(client_id, 'Vision_sensor',sim.sim_scripttype_childscript,'receiveData', inputInts,inputFloats, inputStrings, inputBuffer,sim.simx_opmode_blocking)
